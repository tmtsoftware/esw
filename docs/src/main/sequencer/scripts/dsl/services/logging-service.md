...
The default log level for sequencers can be set using command line options.  See the @ref[SequencerApp documentation](../../../../apps/sequencerapp.md#setting-the-default-log-level) for more information.
