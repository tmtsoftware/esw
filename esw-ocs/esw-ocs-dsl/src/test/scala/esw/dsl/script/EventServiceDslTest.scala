...
//import esw.dsl.script.services.javadsl.JEventServiceDsl
...
//
//class EventServiceDslTest extends BaseTestSuite with JEventServiceDsl {
//  val eventService: IEventService = mock[IEventService]
