...
object Libs {
  ...
  private val MSocketVersion  = "57a4ca8"
  ...
  val `mockito-scala`      = "org.mockito" %% "mockito-scala" % "1.11.1" // MIT License
...
object Csw {
  ...
  private val Version = "5493ea9" //change this to 0.1.0-SNAPSHOT to test with local csw changes (after publishLocal)
