...
object Libs {
  ...
  private val MSocketVersion  = "a3f5b95"
  ...
  val `mockito-scala`      = "org.mockito" %% "mockito-scala" % "1.10.0" // MIT License
...
object Csw {
  ...
  private val Version = "1b6edf5" //change this to 0.1-SNAPSHOT to test with local csw changes (after publishLocal)
