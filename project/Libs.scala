...
object Libs {
  ...
  val `mockito-scala`      = "org.mockito" %% "mockito-scala" % "1.10.2" // MIT License
...
object Csw {
  ...
  private val Version = "9fd41bc" //change this to 0.1-SNAPSHOT to test with local csw changes (after publishLocal)
