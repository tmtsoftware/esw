...
object Libs {
  ...
  val `mockito-scala`      = "org.mockito" %% "mockito-scala" % "1.7.0" // MIT License
...
object Csw {
  ...
  private val Version = "9dbb3c0" //change this to 0.1-SNAPSHOT to test with local csw changes (after publishLocal)
