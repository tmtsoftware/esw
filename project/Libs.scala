...
object Libs {
  ...
  val `mockito-scala`      = "org.mockito" %% "mockito-scala" % "1.10.1" // MIT License
...
object Csw {
  ...
  private val Version = "effc7d2" //change this to 0.1-SNAPSHOT to test with local csw changes (after publishLocal)
