...
object Csw {
  ...
  private val Version = "6be5640" // Change this to 0.1.0-SNAPSHOT to test with local csw changes (after publishLocal)
...
object Kotlin {
  ...
  val `coroutines-jdk8` = "org.jetbrains.kotlinx" % "kotlinx-coroutines-jdk8" % "1.3.6"
