...
object Libs {
  ...
  private val MSocketVersion  = "897361c"
...
object Csw {
  ...
  private val Version = "4387eca5e2" //change this to 0.1-SNAPSHOT to test with local csw changes (after publishLocal)
  ...
  val `csw-location-impl`           = Org %% "csw-location-impl" % Version
  ...
  val `csw-location-impl-multi-jvm` = Org %% "csw-location-impl" % Version classifier "multi-jvm"
  val `csw-location-impl-tests`     = Org %% "csw-location-impl" % Version classifier "tests"
}
