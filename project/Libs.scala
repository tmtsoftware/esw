...
object Libs {
  ...
  private val MSocketVersion  = "0.1.0-RC1"
  ...
  val `case-app`           = "com.github.alexarchambault" %% "case-app" % "2.0.0-M12"
...
object Csw {
  ...
  private val Version = "836bc0e" //change this to 0.1.0-SNAPSHOT to test with local csw changes (after publishLocal)
