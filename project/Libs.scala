...
object Libs {
  ...
  private val MSocketVersion  = "0.1.0"
  ...
  val `tmt-test-reporter` = "com.github.tmtsoftware" %% "rtm" % "c49039e626"
...
object Csw {
  ...
  private val Version = "2.0.0" //change this to 0.1.0-SNAPSHOT to test with local csw changes (after publishLocal)
