...
object Libs {
  ...
  private val MSocketVersion  = "21399f8"
  ...
  val `case-app`           = "com.github.alexarchambault" %% "case-app" % "2.0.0-M10"
...
object Csw {
  ...
  private val Version = "02759fc" //change this to 0.1.0-SNAPSHOT to test with local csw changes (after publishLocal)
